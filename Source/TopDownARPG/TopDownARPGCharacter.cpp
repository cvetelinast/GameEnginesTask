...
void ATopDownARPGCharacter::ChangeSpeed(float speedCoefficient)
{
	UE_LOG(LogTopDownARPG, Display, TEXT("ATopDownARPGCharacter::GetInChronoSphere current speedCoefficient = %f"), speedCoefficient);
